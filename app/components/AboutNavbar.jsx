  ...
  return (
    <section className="h-[492px] w-full relative">
      ...
      <div className="relative z-10 font-quantico">
        ...
        {/* HERO TEXT */}
        <div className="mx-1 my-10 md:mx-40 md:my-20 text-center">
          ...
          <h1 className="font-rammettoOne font-medium md:font-bold text-white text-[13px] md:text-[22px] lg:text-[36px] leading-[100%] mb-3">
            A Team-Driven Digital Agency & Technology Consulting Company
          </h1>
        </div>
      </div>
    </section>
